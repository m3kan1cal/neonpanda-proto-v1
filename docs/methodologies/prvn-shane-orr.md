...
PRVN (Proven) was developed by Shane Orr, a former competitive CrossFit athlete who built the methodology through years of competitive experience and coaching elite functional fitness athletes. Orr's background as both a competitor and coach gave him unique insights into the balance between intensity and longevity in training.

The philosophy behind PRVN emphasizes intelligent training that balances high performance with sustainable health. Orr developed the system to address what he saw as common gaps in functional fitness programming, particularly around movement quality, injury prevention, and systematic progression. His methodology has gained recognition for producing well-rounded athletes who maintain performance over extended careers.
