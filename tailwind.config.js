...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "synthwave-gradient":
          "linear-gradient(135deg, #16213e 0%, #16213e 50%, #16213e 100%)",
        "neon-gradient": "linear-gradient(45deg, #ff0080 0%, #00ffff 100%)",
        "purple-gradient": "linear-gradient(45deg, #9F00FF 0%, #ff0080 100%)",
      ...
      boxShadow: {
        ...
        "neon-purple": "0 0 20px #9F00FF, 0 0 40px #9F00FF, 0 0 60px #9F00FF",
        "neon-maroon":
          "0 0 15px rgba(139, 0, 69, 0.5), 0 0 30px rgba(139, 0, 69, 0.3)",
