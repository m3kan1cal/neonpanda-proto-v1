 ...
 *
 * Generic stepped history caching implementation used across session agents:
 *   - Coach creator sessions
 *   - Program designer sessions
 *   - Workout creators (potentially)
 *
...
// Caching constants (mirror response-orchestrator.ts)
