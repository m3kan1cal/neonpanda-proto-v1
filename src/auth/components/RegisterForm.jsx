  ...
  return (
    <AuthLayout>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Google Sign-Up */}
        <SocialLoginButtons disabled={isSubmitting} mode="signup" />
            ...
            <div className={formPatterns.availabilityContainer}>
              <span className={formPatterns.availabilityIcon}>
                {emailAvailability.status === "checking" && (
                  <svg
                    className="animate-spin h-4 w-4 text-synthwave-text-muted"
                ...
                {emailAvailability.status === "available" && (
                  <svg
                    className="h-4 w-4 text-synthwave-neon-cyan"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                ...
                {emailAvailability.status === "taken" && (
                  <svg
                    className="h-4 w-4 text-synthwave-neon-pink"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
              ...
              <span
                className={
                  emailAvailability.status === "checking"
                    ? formPatterns.availabilityChecking
                    : emailAvailability.status === "available"
                      ? formPatterns.availabilityAvailable
        ...
        {/* Password Requirements — shown on focus or when field has content/error */}
        {(passwordFocused || formData.password || errors.password) && (
