...
const AuthButton = ({
  ...
  const variantClasses = {
    ...
    link: `w-full bg-transparent border-none text-synthwave-neon-cyan px-4 py-2 hover:text-white hover:bg-synthwave-neon-cyan/15 hover:-translate-y-0.5 rounded-md active:translate-y-0 backdrop-blur-sm focus:ring-2 focus:ring-synthwave-neon-cyan/40 focus:ring-offset-0 focus:ring-offset-transparent transition-all duration-200 font-body font-medium uppercase tracking-wide disabled:hover:bg-transparent disabled:hover:text-synthwave-neon-cyan disabled:hover:translate-y-0 disabled:opacity-60 min-h-[48px] flex items-center justify-center`
  };
