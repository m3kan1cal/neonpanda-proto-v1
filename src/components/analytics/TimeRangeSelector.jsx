...
export default function TimeRangeSelector({ value = "8w", onChange }) {
  return (
    <div className="flex items-center gap-1 rounded-md bg-synthwave-bg-card/50 border border-synthwave-neon-cyan/10 p-0.5">
      {RANGES.map((r) => {
        ...
        return (
          <button
            ...
            className={`px-2.5 py-1 rounded-md font-body font-bold text-xs uppercase tracking-wide transition-all duration-200 ${
              isActive
