...
const CollapsibleSection = ({
  ...
  return (
    <div
      id={id}
      className={`${containerPatterns.collapsibleSection} ${className} scroll-mt-24`}
    >
      <button
    ...
    <div className={layoutPatterns.pageContainer}>
      ...
      >
        ...
        <div className="mb-12 text-center">
          <h1 className={typographyPatterns.pageTitle}>Changelog</h1>
              ...
              {changelogEntries.map((entry, index) => (
                ...
                >
                  <div className="space-y-6">
                    ...
                    {entry.changes.infrastructure && (
                      <div className="mb-6">
                        <h3 className={formPatterns.subsectionHeader}>
                          <svg
                            className="w-5 h-5 text-synthwave-text-muted"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                        ...
                        <ul className="space-y-2">
                          {entry.changes.infrastructure.map((item, i) => (
                            <li
                              key={i}
                              className="text-synthwave-text-muted font-body flex items-start"
                            >
                              <span className="text-synthwave-text-muted mr-2">
                                •
                              </span>
                              {item}
                            </li>
