// QuickAccessPopover.jsx - Popover component for Quick Access sidebar items
// Reuses FloatingMenuManager logic for displaying recent items and actions
...
/**
 * QuickAccessPopover - Renders popovers for Quick Access sidebar items
 * Integrates with agents to show recent conversations, workouts, reports, and actions
 */
export const QuickAccessPopover = ({
  isOpen,
  onClose,
  popoverType,
  userId,
  ...
  // Initialize agents (same as FloatingMenuManager)
  useEffect(() => {
    if (!userId) return;
  ...
  // Render functions (extracted from FloatingMenuManager)
      ...
      {workoutAgentState.isLoadingRecentItems ? (
        <div className="space-y-3">
          ...
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-synthwave-bg-primary/30 border border-synthwave-neon-pink/20 rounded-xl p-3"
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <div className="h-4 bg-synthwave-text-muted/20 rounded-xl animate-pulse w-3/4 mb-2"></div>
                  <div className="h-3 bg-synthwave-text-muted/20 rounded-xl animate-pulse w-1/2"></div>
                </div>
                <div className="w-4 h-4 bg-synthwave-text-muted/20 rounded-xl animate-pulse ml-2"></div>
              </div>
            </div>
          ))}
        </div>
          ...
          {workoutAgentState.recentWorkouts.map((workout) => {
            ...
            return (
              <div
                ...
                className="relative bg-synthwave-bg-primary/30 border border-synthwave-neon-pink/20 hover:border-synthwave-neon-pink/40 hover:bg-synthwave-bg-primary/50 rounded-xl p-3 cursor-pointer transition-all duration-200"
              >
                {isNew && <NewBadge />}
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
        ...
        <div className="space-y-3">
          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <div className="h-4 bg-synthwave-text-muted/20 rounded-xl animate-pulse w-1/3 mb-2"></div>
                  <div className="h-3 bg-synthwave-text-muted/20 rounded-xl animate-pulse w-2/3"></div>
                </div>
                <div className="w-4 h-4 bg-synthwave-text-muted/20 rounded-xl animate-pulse ml-2"></div>
              </div>
            </div>
        ...
        <div className="space-y-3">
          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <div className="h-4 bg-synthwave-text-muted/20 rounded-xl animate-pulse w-2/3 mb-2"></div>
                  <div className="h-3 bg-synthwave-text-muted/20 rounded-xl animate-pulse w-1/2"></div>
                </div>
                <div className="w-4 h-4 bg-synthwave-text-muted/20 rounded-xl animate-pulse ml-2"></div>
              </div>
  ...
  const renderCoachDetails = () => {
    ...
    // Full coach details view (copied from FloatingMenuManager)
    // Full coach details view (copied from FloatingMenuManager)
    return (
  ...
  // Determine popover content based on type
  const getPopoverContent = () => {
    switch (popoverType) {
      case "menu":
        return renderMainActionsMenu();
      case "conversations":
  ...
  // Calculate popover position (to the right of sidebar)
  const popoverPosition = isSidebarCollapsed
    ? "lg:left-[80px]" // 80px = 64px (collapsed sidebar w-16) + 16px margin
    : "lg:left-[272px]"; // 272px = 256px (expanded sidebar w-64) + 16px margin
