  ...
  return (
    <div className={`${containerPatterns.cardMedium} p-6`}>
      ...
      <button
        ...
        className="font-body text-lg text-white hover:text-synthwave-neon-cyan transition-colors mb-2 text-left font-semibold"
      >
        {program.name}
      </button>
      ...
      {phaseName && (
        <div className="bg-synthwave-bg-primary/30 border border-synthwave-neon-cyan/20 p-3 mb-4">
          <div className="font-body text-xs text-synthwave-text-secondary uppercase tracking-wider mb-1">
            Current Phase
          </div>
