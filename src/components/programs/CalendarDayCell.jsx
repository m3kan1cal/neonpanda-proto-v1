...
export default function CalendarDayCell({
  ...
  const handleClick = () => {
    ...
    if (isCurrentDay) {
      navigate(`/training-grounds/programs/workouts?userId=${userId}&coachId=${coachId}&programId=${programId}`);
    } else {
      navigate(`/training-grounds/programs/workouts?userId=${userId}&coachId=${coachId}&programId=${programId}&day=${day.dayNumber}`);
    }
  };
