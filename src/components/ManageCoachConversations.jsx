    ...
    return (
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 actions-menu-container">
          ...
          {openMenuId === conversation.conversationId && (
            <div className="absolute right-0 mt-2 w-52 bg-synthwave-bg-card border border-synthwave-neon-cyan/20 rounded-xl shadow-[4px_4px_16px_rgba(0,255,255,0.06)] overflow-hidden z-20">
              <button
                onClick={(e) => {
                  e.stopPropagation();
