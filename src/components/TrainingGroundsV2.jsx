  ...
  const renderReportsCard = () => (
    <div className={`${containerPatterns.cardMedium} p-6`}>
      ...
      <Link
        ...
        className="mt-3 flex items-center justify-between px-4 py-3 rounded-full bg-synthwave-neon-purple/10 border border-synthwave-neon-purple/30 hover:bg-synthwave-neon-purple/20 hover:border-synthwave-neon-purple/50 transition-all duration-200 active:scale-[0.97] active:shadow-neon-purple touch-manipulation [-webkit-tap-highlight-color:transparent] group"
      >
