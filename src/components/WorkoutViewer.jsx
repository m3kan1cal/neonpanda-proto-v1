          ...
          <div className={`${containerPatterns.cardMedium} overflow-hidden`}>
            ...
            {!collapsedSections.has(2) && (
              ...
              >
                ...
                {/* Subsection: AI Insights - Collapsible */}
                {workout.insights && (
                  <div>
                    <button
                    ...
                    {!collapsedSubsections.has("ai-insights") && (
                      ...
                      >
                        ...
                        {workout.insights.achievements && (
                          <div>
                            <span className="font-body text-xs uppercase tracking-wider text-synthwave-neon-pink">
                              Achievements
                            </span>
                            <p className="text-synthwave-text-secondary font-body text-sm leading-relaxed mt-0.5">
                              {workout.insights.achievements}
                        ...
                        {workout.insights.scalingAnalysis && (
                          <div>
                            <span className="font-body text-xs uppercase tracking-wider text-synthwave-neon-purple">
                              Template Adherence
                            </span>
                            <p className="text-synthwave-text-secondary font-body text-sm leading-relaxed mt-0.5">
                              {workout.insights.scalingAnalysis}
                        ...
                        {workout.insights.recoveryImpact && (
                          <div>
                            <span className="font-body text-xs uppercase tracking-wider text-yellow-400">
                              Recovery Impact
                            </span>
                            <p className="text-synthwave-text-secondary font-body text-sm leading-relaxed mt-0.5">
                              {workout.insights.recoveryImpact}
