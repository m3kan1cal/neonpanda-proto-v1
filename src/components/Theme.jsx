    ...
    <div className={`${themeClasses.container} min-h-screen pb-8`}>
      <div className="max-w-7xl mx-auto px-8 py-12 min-h-[calc(100vh-5rem)] flex flex-col">
        ...
        <div className="mb-8 text-center">
          <h1 className="font-header font-black text-4xl md:text-5xl text-white mb-6 uppercase">
            Synthwave Design System Showcase
          </h1>
          <p className="font-body text-lg text-synthwave-text-secondary max-w-3xl mx-auto mb-4">
            Comprehensive collection of all existing design elements and modern
            UI/UX proposals for the synthwave theme.
          </p>
        </div>
        ...
        <div className="flex-1">
          <NeonBorder
            color={activeSection === "existing" ? "pink" : "cyan"}
            ...
            <div className="p-6 h-full overflow-y-auto custom-scrollbar">
              ...
              {activeCategory === "buttons" && activeSection === "existing" && (
                <div className="space-y-12">
                  <h2 className="font-header text-3xl text-synthwave-neon-pink mb-8 text-center uppercase">
                    Existing Button Inventory
                  </h2>

                  {/* Auth Buttons Section */}
                  <section className="space-y-6">
                    <h3 className="font-header text-xl text-white mb-4 uppercase border-b border-synthwave-neon-pink/30 pb-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="space-y-4">
                        ...
                        <AuthButton variant="primary" loading>
                          Loading...
                        </AuthButton>
                      ...
                      <div className="space-y-4">
                        ...
                        <AuthButton variant="secondary" loading>
                          Loading...
                        </AuthButton>
                      ...
                      <div className="space-y-4">
                        <h4 className="font-body text-lg text-synthwave-neon-purple">
                          Link Variant (Updated)
                        </h4>
                        <AuthButton variant="link">Forgot Password?</AuthButton>
                        <AuthButton variant="link" loading>
                          Loading...
                        </AuthButton>
                        <AuthButton variant="link" disabled>
                          Disabled
                        </AuthButton>
                      </div>
                    </div>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <IconButton variant="bordered" disabled>
                          <HeartIcon />
                        </IconButton>
                      </div>
                      <div className="space-y-4">
                        <h4 className="font-body text-lg text-synthwave-neon-cyan">
                          Solid Cyan (Management)
                        </h4>
                        <IconButton variant="solidCyan">
                          <SettingsIcon />
                        </IconButton>
                        <IconButton variant="solidCyan" disabled>
                          <SettingsIcon />
                        </IconButton>
                      </div>
                      <div className="space-y-4">
                        ...
                        <IconButton variant="floating">
                          <SampleIcon />
                        </IconButton>
                        <IconButton variant="floating" disabled>
                          <SampleIcon />
                        </IconButton>
                      </div>
                    </div>
                    <div className="bg-synthwave-bg-card/20 border border-synthwave-neon-pink/20 rounded-xl p-4 mt-6">
                      <p className="text-synthwave-text-secondary font-body text-sm">
                        ...
                        Now uses standardized iconButtonPatterns from
                        uiPatterns.js. Legacy variants (default, cyan, active,
                        small) are mapped to new standardized variants for
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <button
                          className={`${themeClasses.neonButton} opacity-50 cursor-not-allowed`}
                          disabled
                        >
                          Disabled Neon
                        </button>
                      ...
                      <div className="space-y-4">
                        ...
                        <button
                          className={`${themeClasses.cyanButton} opacity-50 cursor-not-allowed`}
                          disabled
                        >
                          Disabled Cyan
                        </button>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      <div className="space-y-4">
                        <h4 className="font-body text-lg text-blue-400">
                          Plus Action
                        </h4>
                      ...
                      <div className="space-y-4">
                        <h4 className="font-body text-lg text-purple-400">
                          Paperclip Action
                        </h4>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-4">
                      <button className="bg-synthwave-bg-primary/30 border border-synthwave-neon-pink/30 text-synthwave-neon-pink px-3 py-1 rounded-full text-sm font-body hover:bg-synthwave-neon-pink/10 transition-colors duration-300">
                        /log-workout
                      </button>
                      <button className="bg-synthwave-bg-primary/30 border border-synthwave-neon-pink/30 text-synthwave-neon-pink px-3 py-1 rounded-full text-sm font-body hover:bg-synthwave-neon-pink/10 transition-colors duration-300">
                        /save-memory
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="bg-synthwave-bg-primary/30 border border-synthwave-neon-pink/20 hover:border-synthwave-neon-pink/40 hover:bg-synthwave-bg-primary/50 rounded-xl p-3 cursor-pointer transition-all duration-200">
                        <p className="text-synthwave-text-primary font-body">
                          Card with hover effect
                        </p>
                      </div>
                      <div className="bg-synthwave-bg-primary/30 border border-synthwave-neon-pink/20 rounded-xl p-3">
                        <p className="text-synthwave-text-primary font-body">
                  ...
                  <section className="space-y-6">
                    ...
                    <button className="w-full px-4 py-3 bg-synthwave-bg-primary/30 hover:bg-synthwave-bg-primary/50 transition-colors duration-200 flex items-center justify-between text-left rounded-xl border border-synthwave-neon-pink/30">
                      <span className="text-synthwave-text-primary font-body">
              ...
              {activeCategory === "buttons" && activeSection === "proposed" && (
                <div className="space-y-12">
                  <h2 className="font-header text-3xl text-synthwave-neon-cyan mb-8 text-center uppercase">
                    Modern UI/UX Button Proposals
                  </h2>

                  {/* Primary Action Buttons */}
                  <section className="space-y-6">
                    <h3 className="font-header text-xl text-white mb-4 uppercase border-b border-synthwave-neon-cyan/30 pb-2">
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                      {/* Minimal Clean */}
                      <div className="space-y-4">
                        <h4 className="font-body text-sm text-synthwave-text-primary">
                          Minimal
                        </h4>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <button
                          className={iconButtonPatterns.actionSmallPurple}
                        >
                          <svg
                            className="w-5 h-5"
                            fill="none"
                    ...
                    <div className="bg-synthwave-bg-card/20 border border-synthwave-neon-cyan/20 rounded-xl p-4">
                      <p className="text-synthwave-text-secondary font-body text-sm">
                        <strong className="text-synthwave-neon-cyan">
                          Small Action Buttons:
                        </strong>{" "}
                        Designed for chat interfaces and toolbars. Smaller than
                        regular icon buttons (40px vs 48px), use rounded-xl
                        ...
                        cyan=utility).
                        <strong className="text-synthwave-neon-pink ml-2">
                          Icons:
                        </strong>{" "}
                        All action button icons should be w-5 h-5 (20px) for
                        consistent sizing.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                      {/* Pink Badge */}
                      <div className="space-y-4">
                        <h4 className="font-body text-sm text-synthwave-neon-pink">
                          Pink
                        </h4>
                        <span className="bg-synthwave-neon-pink/20 text-synthwave-neon-pink px-2 py-1 rounded-xl text-xs font-body font-medium inline-block">
                          High Priority
                        </span>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <span className="bg-synthwave-neon-pink/20 text-synthwave-neon-pink px-2 py-1 rounded-xl text-xs font-body font-medium border border-synthwave-neon-pink/40 inline-block">
                          Strength
                        </span>
                      </div>
                      ...
                      {/* Cyan Badge */}
                      <div className="space-y-4">
                        <h4 className="font-body text-sm text-synthwave-neon-cyan">
                          Cyan
                        </h4>
                        <span className="bg-synthwave-neon-cyan/20 text-synthwave-neon-cyan px-2 py-1 rounded-xl text-xs font-body font-medium inline-block">
                          Info Tag
                        </span>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <span className="bg-synthwave-neon-cyan/20 text-synthwave-neon-cyan px-2 py-1 rounded-xl text-xs font-body font-medium border border-synthwave-neon-cyan/40 inline-block">
                          Conditioning
                        </span>
                      </div>
                      ...
                      {/* Purple Badge */}
                      <div className="space-y-4">
                        <h4 className="font-body text-sm text-synthwave-neon-purple">
                          Purple
                        </h4>
                        <span className="bg-synthwave-neon-purple/20 text-synthwave-neon-purple px-2 py-1 rounded-xl text-xs font-body font-medium inline-block">
                          Special
                        </span>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <span className="bg-synthwave-neon-purple/20 text-synthwave-neon-purple px-2 py-1 rounded-xl text-xs font-body font-medium border border-synthwave-neon-purple/40 inline-block">
                          Accessory
                        </span>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <span className="px-2 py-1 bg-synthwave-bg-primary/50 border border-synthwave-neon-cyan/30 rounded-xl text-sm font-body text-synthwave-text-secondary inline-block">
                          Barbell
                        </span>
                      </div>
                    </div>

                    <div className="bg-synthwave-bg-card/20 border border-synthwave-neon-pink/20 rounded-xl p-4">
                      <p className="text-synthwave-text-secondary font-body text-sm">
                        <strong className="text-synthwave-neon-pink">
                          Badge Patterns:
                        </strong>{" "}
                        Small tag-like components for categorization and
                        labeling. Used in workout types, memory tags, and other
                        metadata displays. Available in pink (high priority),
                        cyan (info), purple (special), and muted variants. Both
                        solid background and bordered versions are available
                        from{" "}
                        <strong className="text-synthwave-neon-cyan">
                          badgePatterns
                        </strong>{" "}
                        in uiPatterns.js. The{" "}
                        <strong className="text-synthwave-neon-cyan">
                          workoutDetail
                        </strong>{" "}
                        pattern is used for equipment, exercises, and focus
                        areas in workout templates.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-synthwave-text-secondary font-body text-xs">
                          Enhanced with subtle background, better padding, and
                      ...
                      <div className="space-y-4">
                        ...
                        <button className="bg-transparent border-none text-synthwave-neon-pink px-2 py-1 hover:text-white transition-all duration-200 font-body font-medium uppercase tracking-wide underline decoration-synthwave-neon-pink/50 hover:decoration-white underline-offset-4">
                          Go Back
                        </button>
                        <p className="text-synthwave-text-secondary font-body text-xs">
                          Classic underline approach with modern hover
                          transitions.
                        </p>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-synthwave-text-secondary font-body text-xs">
                          Ultra-minimal with just color change and subtle
                          background.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-cyan/30 rounded-xl p-6 mt-6">
                      <h4 className="font-body text-lg text-synthwave-neon-cyan font-semibold mb-4">
                        Link Button Best Practices:
                      </h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-body">
                        <div>
                          <h5 className="text-synthwave-neon-pink font-semibold mb-2">
                            When to Use:
                          </h5>
                          <ul className="space-y-1 text-synthwave-text-secondary">
                            <li>
                              • Secondary actions (Forgot password, Cancel)
                            </li>
                        ...
                        <div>
                          <h5 className="text-synthwave-neon-cyan font-semibold mb-2">
                            Modern Features:
                          </h5>
                          <ul className="space-y-1 text-synthwave-text-secondary">
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-center gap-2 p-4 bg-synthwave-bg-card/30 rounded-xl">
                        ...
                        <p className="text-synthwave-text-secondary font-body text-sm">
                          Used for switching between weekly and monthly reports.
                          Active state has cyan background and border, inactive
                          has cyan text with subtle hover state.
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-body">
                        <div>
                          ...
                          <ul className="space-y-1 text-synthwave-text-secondary">
                            ...
                            <li>
                              • Toggling between report types (weekly/monthly)
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-1 text-synthwave-text-secondary">
                            <li>
                              • Active: bg-synthwave-neon-cyan/20 with border
                            </li>
                            ...
                            <li>• Border: 2px with rounded-xl corners</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-cyan/30 rounded-xl p-6">
                      <div className="space-y-4">
                        <h4 className="font-body text-lg text-synthwave-neon-cyan font-semibold">
                          Modern Best Practices:
                        </h4>
                        <ul className="space-y-2 text-synthwave-text-primary font-body">
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                              •
                            </span>
                            <span>
                              <strong>Touch Targets:</strong> Minimum 44px for
                          ...
                          <li className="flex items-start space-x-2">
                            ...
                            <span>
                              <strong>Visual Hierarchy:</strong> Solid fills for
                              primary actions, outlines for secondary
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Feedback:</strong> Subtle hover animations
                              (-translate-y-0.5) and focus rings
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Loading States:</strong> Clear progress
                              indicators with disabled styling
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Color Coding:</strong> Pink for primary,
                              cyan for secondary, red for destructive
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Consistency:</strong> Unified border
                              radius (lg for buttons, xl for cards)
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Accessibility:</strong> Focus rings,
                              proper contrast ratios, keyboard navigation
                            </span>
                          </li>
                        </ul>
                      </div>
                ...
                activeSection === "existing" && (
                  <div className="space-y-12">
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <h4 className="font-body text-lg text-synthwave-neon-cyan font-semibold">
                          NeonBorder Cyan (Used on Workouts, Reports,
                          Conversations, etc.)
                        </h4>
                        <NeonBorder
                          color="cyan"
                        ...
                        >
                          <div className="p-6 h-full overflow-y-auto custom-scrollbar">
                            <h5 className="font-header text-lg text-white mb-4 uppercase">
                              Current Main Container
                            </h5>
                            <p className="text-synthwave-text-primary font-body mb-4">
                              This is the current main content container used
                              across Workouts.jsx, WeeklyReports.jsx,
                              CoachConversations.jsx, and other detail pages. It
                              features a bright cyan neon border with shadow
                              effects.
                            </p>
                            <div className="space-y-2">
                              <div className="bg-synthwave-bg-primary/30 p-3 rounded-xl">
                                <p className="text-synthwave-text-secondary text-sm font-body">
                                  Sample content area
                                </p>
                              </div>
                              <div className="bg-synthwave-bg-primary/30 p-3 rounded-xl">
                        ...
                        <div className="bg-synthwave-bg-card/20 border border-synthwave-neon-cyan/20 rounded-xl p-4">
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            ...
                            Heavy visual weight, competes with content, harsh on
                            eyes, feels dated (2020 aesthetic), poor mobile
                            experience with sharp borders.
                          </p>
                        </div>
                      </div>
                    </section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          ...
                          <div className={themeClasses.glowCard}>
                            <h5 className={themeClasses.cardTitle}>
                              Card Title
                            </h5>
                            <p className={themeClasses.cardText}>
                              This is a glow card with hover effects, border
                              animations, and shadow glow. Perfect for feature
                              highlights and important content sections.
                            </p>
                          </div>
                        </div>
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-gradient p-6 rounded-xl border border-synthwave-neon-cyan/30">
                            <h5 className="font-header text-xl text-white mb-4 uppercase">
                              Container
                            </h5>
                            <p className="font-body text-synthwave-text-secondary">
                              Standard container with gradient background and
                              subtle border. Used for main page layouts and
                              content sections.
                            </p>
                          </div>
                        </div>
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-primary/30 border border-synthwave-neon-pink/20 hover:border-synthwave-neon-pink/40 hover:bg-synthwave-bg-primary/50 rounded-xl p-4 cursor-pointer transition-all duration-200">
                            <h5 className="font-body text-lg text-synthwave-text-primary mb-2">
                              Workout Card
                            </h5>
                            <p className="text-synthwave-text-secondary text-sm font-body">
                              Clickable card with hover effects. Used for
                              workouts, conversations, and reports.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/50 border border-synthwave-neon-cyan/30 rounded-xl p-4">
                            <h5 className="font-body text-lg text-synthwave-text-primary mb-2">
                              Info Card
                            </h5>
                            <p className="text-synthwave-text-secondary text-sm font-body">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/80 backdrop-blur-sm border border-synthwave-neon-purple/30 rounded-xl p-4 shadow-lg shadow-synthwave-neon-purple/20">
                            ...
                            <p className="text-synthwave-text-secondary text-sm font-body">
                              Floating card with backdrop blur and enhanced
                              shadows. Used for overlays and menus.
                            </p>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="flex justify-end">
                            <div className="bg-synthwave-neon-pink/70 text-white border border-synthwave-neon-pink/30 rounded-br-md rounded-tl-lg rounded-bl-lg p-4 max-w-xs shadow-lg shadow-synthwave-neon-pink/20">
                              <p className="font-body">
                                This is a user message with soft pink background
                                and proper contrast.
                              </p>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-start">
                            <div className="bg-synthwave-neon-cyan/10 text-synthwave-text-primary border border-synthwave-neon-cyan/30 rounded-bl-md rounded-tr-lg rounded-br-lg p-4 max-w-xs">
                              <p className="font-body">
                                This is an AI response with lighter cyan
                                background and consistent border styling.
                              </p>
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="relative">
                        <div className="bg-synthwave-bg-card/95 backdrop-blur-lg border-t-2 border-synthwave-neon-pink/30 shadow-lg shadow-synthwave-neon-pink/20 rounded-xl p-6">
                          <h4 className="font-body text-lg text-synthwave-neon-pink mb-4">
                            Chat Input Container
                          </h4>
                          <p className="text-synthwave-text-secondary font-body mb-4">
                            Fixed positioning container with backdrop blur,
                            gradient background, and neon border effects. Stays
                            visible during scroll with glassmorphism styling.
                          </p>
                          <div className="flex items-center space-x-4">
                            <div className="flex-1 bg-synthwave-bg-primary/50 border border-synthwave-neon-pink/30 rounded-xl p-3">
                              <span className="text-synthwave-text-muted font-body">
                                Type your message...
                              </span>
                            </div>
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="border border-synthwave-neon-pink/30 rounded-xl overflow-hidden">
                          ...
                          <div className="p-4 bg-synthwave-bg-card/20">
                            <p className="text-synthwave-text-primary font-body">
                              Expandable content section with header button and
                              collapsible body. Used throughout the app for
                  ...
                  <div className="space-y-12">
                    ...
                    <section className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                          <h4 className="font-body text-lg text-synthwave-neon-pink font-semibold">
                            Option 1: Subtle Glassmorphism (Recommended)
                          </h4>
                          <div className="bg-synthwave-bg-card/30 backdrop-blur-xl border border-synthwave-neon-cyan/10 rounded-xl shadow-xl shadow-synthwave-neon-cyan/5 h-64 overflow-hidden transition-all duration-300 hover:bg-synthwave-bg-card/40 hover:border-synthwave-neon-cyan/15">
                            <div className="p-6 h-full overflow-y-auto custom-scrollbar">
                              <h5 className="font-header text-lg text-white mb-4 uppercase">
                                Modern Glassmorphism
                              </h5>
                              <p className="text-synthwave-text-primary font-body mb-4">
                                Subtle glassmorphism with minimal borders.
                                Provides modern depth without competing with
                                content. Perfect balance of style and
                                functionality.
                              </p>
                              <div className="space-y-2">
                          ...
                          <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                            <p className="text-green-400 font-body text-sm">
                              ...
                              mobile optimized, maintains brand subtly,
                              future-proof design.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          <h4 className="font-body text-lg text-synthwave-neon-purple font-semibold">
                            Option 2: Enhanced Glassmorphism
                          </h4>
                          <div className="bg-gradient-to-br from-synthwave-bg-card/40 to-synthwave-bg-card/20 backdrop-blur-2xl border border-synthwave-neon-cyan/15 rounded-xl shadow-2xl shadow-synthwave-neon-cyan/10 h-64 overflow-hidden">
                            <div className="p-6 h-full overflow-y-auto custom-scrollbar">
                              <h5 className="font-header text-lg text-white mb-4 uppercase">
                                Enhanced Glass
                              </h5>
                              <p className="text-synthwave-text-primary font-body mb-4">
                                ...
                                and stronger shadows. More visual impact while
                                staying modern.
                              </p>
                              <div className="space-y-2">
                                ...
                                <div className="bg-synthwave-bg-primary/30 border border-synthwave-neon-cyan/20 rounded-xl px-4 py-4">
                                  <p className="text-synthwave-text-secondary text-sm font-body">
                      ...
                      <div className="space-y-4 mt-8">
                        <h4 className="font-body text-lg text-synthwave-text-primary font-semibold">
                          Option 3: Minimal Modern (Clean)
                        </h4>
                        <div className="bg-synthwave-bg-card/25 rounded-xl shadow-xl h-64 overflow-hidden border-0">
                          <div className="p-6 h-full overflow-y-auto custom-scrollbar">
                            <h5 className="font-header text-lg text-white mb-4 uppercase">
                              Minimal Clean
                            </h5>
                            <p className="text-synthwave-text-primary font-body mb-4">
                              Ultra-minimal approach with no borders, just
                              subtle background and shadows. Maximum content
                        ...
                        <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
                          <p className="text-purple-400 font-body text-sm">
                            ...
                            on any screen size, timeless design.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-synthwave-neon-pink/10 border border-synthwave-neon-pink/30 rounded-xl p-6 mt-8">
                        <h4 className="font-header text-lg text-synthwave-neon-pink mb-4 uppercase">
                          My Recommendation
                        </h4>
                        <p className="text-synthwave-text-primary font-body mb-4">
                          <strong>Option 1 (Subtle Glassmorphism)</strong> is
                          the sweet spot for your main content containers. It
                          maintains the synthwave brand identity while embracing
                          modern 2025 design standards. The subtle cyan hints
                          preserve your color theme without overwhelming the
                          content.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-body">
                          <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-6 shadow-xl">
                            <h5 className="font-header text-lg text-white mb-3 uppercase">
                              Light Glass
                            </h5>
                            <p className="text-synthwave-text-secondary font-body text-sm">
                              Subtle glassmorphism with light background blur
                              and minimal borders. Perfect for overlays and
                              floating elements.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/30 backdrop-blur-lg border border-synthwave-neon-cyan/20 rounded-xl p-6 shadow-xl shadow-synthwave-neon-cyan/10">
                            <h5 className="font-header text-lg text-white mb-3 uppercase">
                              Medium Glass
                            </h5>
                            <p className="text-synthwave-text-secondary font-body text-sm">
                              Enhanced glassmorphism with themed background and
                              colored shadows. Ideal for main content areas and
                              cards.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/50 backdrop-blur-xl border border-synthwave-neon-purple/30 rounded-xl p-6 shadow-2xl shadow-synthwave-neon-purple/20">
                            <h5 className="font-header text-lg text-white mb-3 uppercase">
                              Heavy Glass
                            </h5>
                            <p className="text-synthwave-text-secondary font-body text-sm">
                              Strong glassmorphism with pronounced blur and
                              enhanced shadows. Best for modals and important UI
                              elements.
                            </p>
                          </div>
                        </div>
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-gradient-to-br from-synthwave-bg-card/80 to-synthwave-bg-primary/80 border border-synthwave-neon-pink/20 rounded-xl p-6">
                            ...
                            <p className="text-synthwave-text-secondary font-body">
                              Gentle gradient from card to primary background
                              colors. Provides depth without overwhelming
                              content.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-gradient-to-br from-synthwave-neon-pink/20 via-synthwave-neon-purple/10 to-synthwave-neon-cyan/20 border border-synthwave-neon-cyan/30 rounded-xl p-6">
                            ...
                            <p className="text-synthwave-text-secondary font-body">
                              ...
                              Creates visual interest for hero sections and
                              highlights.
                            </p>
                          </div>
                        </div>
                      ...
                      {/* CTA Container - Hybrid Style */}
                      <div className="mt-8">
                        <h4 className="font-body text-lg text-synthwave-neon-pink font-semibold mb-4">
                        ...
                        <div className="bg-gradient-to-br from-synthwave-neon-pink/20 via-synthwave-neon-purple/10 to-synthwave-neon-cyan/20 border border-synthwave-neon-pink/30 rounded-xl p-6 shadow-xl shadow-synthwave-neon-pink/20 hover:shadow-2xl hover:shadow-synthwave-neon-pink/30 transition-all duration-300 hover:-translate-y-2">
                          ...
                          <p className="text-synthwave-text-secondary font-body mb-4">
                            Combines Bold Gradient's visual impact with Elevated
                            Card's interactive hover effects. Perfect for
                            premium tier CTAs, upgrade prompts, and special
                            offers.
                          </p>
                          <ul className="space-y-2 text-synthwave-text-secondary font-body text-sm">
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-pink mt-0.5">
                                •
                              </span>
                              <span>
                                Multi-color gradient background (pink → purple →
                                cyan)
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              ...
                              <span>
                                Strong shadow elevation with pink glow
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-purple mt-0.5">
                                •
                              </span>
                              <span>
                                Interactive hover animation (lift -2px +
                                enhanced shadow)
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              ...
                              <span>
                                Smooth 300ms transitions for polished feel
                              </span>
                            </li>
                          </ul>
                        </div>
                        <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 mt-4">
                          <p className="text-green-400 font-body text-sm">
                            ...
                            offers, limited-time promotions, and any container
                            that needs maximum visual impact with interactive
                            feedback.
                          </p>
                        </div>
                      </div>
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/20 hover:bg-synthwave-bg-card/40 border-0 rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-synthwave-neon-pink/10">
                            <div className="flex items-start space-x-3 mb-4">
                              <div className="w-3 h-3 bg-synthwave-neon-pink rounded-full shrink-0 mt-2"></div>
                              <h5 className="font-header text-lg text-white uppercase">
                                Minimal
                              </h5>
                            </div>
                            <p className="text-synthwave-text-secondary font-body text-sm">
                              Clean, borderless design with subtle hover
                              effects. Modern approach focusing on content over
                              decoration.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-transparent hover:bg-synthwave-neon-cyan/5 border-2 border-synthwave-neon-cyan/30 hover:border-synthwave-neon-cyan/60 rounded-xl p-6 transition-all duration-300 hover:-translate-y-1">
                            <div className="flex items-start space-x-3 mb-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/60 border border-synthwave-neon-purple/20 rounded-xl p-6 shadow-xl shadow-synthwave-neon-purple/20 hover:shadow-2xl hover:shadow-synthwave-neon-purple/30 transition-all duration-300 hover:-translate-y-2">
                            <div className="flex items-start space-x-3 mb-4">
                            ...
                            <p className="text-synthwave-text-secondary font-body text-sm">
                              Strong shadow elevation with enhanced hover
                              effects. Creates depth hierarchy and draws
                              attention.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/60 border border-synthwave-neon-cyan/20 rounded-xl p-6 shadow-xl shadow-synthwave-neon-cyan/20 hover:border-synthwave-neon-cyan/40 hover:bg-synthwave-bg-card/40 transition-all duration-300 hover:-translate-y-1">
                            <p className="text-synthwave-text-primary font-body text-base mb-3 leading-relaxed">
                              This is a content-focused card without headers.
                              Perfect for displaying user-generated content like
                              memories, notes, or messages where the content
                              itself is the primary focus.
                            </p>
                            <div className="flex flex-wrap items-center gap-4 font-body text-synthwave-text-primary text-sm">
                              <div className="bg-synthwave-neon-cyan/20 text-synthwave-neon-cyan px-2 py-1 rounded-xl text-xs font-body">
                                Personal
                              </div>
                              <div className="bg-synthwave-neon-pink/20 text-synthwave-neon-pink px-2 py-1 rounded-xl text-xs font-body">
                                High Priority
                              </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <p className="text-synthwave-text-secondary font-body text-xs">
                            Static information display without hover effects.
                            Used for coach config details, metadata, and
                            non-interactive content sections.
                          </p>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className={containerPatterns.minimalCardStatic}>
                            ...
                            <p className="text-synthwave-text-secondary font-body text-sm">
                              Be specific about your fitness objectives. Instead
                              of "get stronger," try "increase my deadlift 1RM
                              by 20 pounds" or "complete 10 unbroken pull-ups."
                            </p>
                          </div>
                          <p className="text-synthwave-text-secondary font-body text-xs">
                            Static tips content card without hover effects or
                            color dots. Used in ChatInput tips popup for clean,
                            minimal help content display.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mt-8">
                        ...
                        <div className="bg-synthwave-bg-card/20 backdrop-blur-sm border-2 border-dashed border-synthwave-neon-pink/30 rounded-xl shadow-lg shadow-synthwave-neon-pink/10 transition-all duration-300 hover:bg-synthwave-bg-card/40 hover:border-synthwave-neon-pink/50 hover:shadow-xl hover:shadow-synthwave-neon-pink/20 hover:-translate-y-1 p-6">
                          ...
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            ...
                            Perfect for "Add New Coach" cards and other creation
                            interfaces. Uses pink theme for primary creation
                            actions.
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-pink/20 rounded-xl p-6 relative overflow-hidden">
                            ...
                            <div className="relative">
                              ...
                              <div className="space-y-2">
                                <div className="h-3 bg-synthwave-text-muted/20 rounded-xl animate-pulse"></div>
                                <div className="h-3 bg-synthwave-text-muted/20 rounded-xl animate-pulse w-3/4"></div>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className={containerPatterns.errorState}>
                            ...
                            <p className="text-red-300 font-body text-sm">
                              Error state container with appropriate color
                              coding and iconography. Clearly communicates
                              issues while maintaining design consistency.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-end">
                            <div className="bg-gradient-to-br from-synthwave-neon-pink/80 to-synthwave-neon-pink/60 text-white border-0 rounded-xl rounded-br-md p-4 max-w-xs shadow-xl shadow-synthwave-neon-pink/30 backdrop-blur-sm">
                              <p className="font-body">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-start">
                            <div
                              className={`${containerPatterns.aiChatBubble} p-4 max-w-xs`}
                            >
                              <p className="font-body">
                                Glassmorphism AI bubble with backdrop blur and
                                subtle shadows for modern depth perception.
                              </p>
                              <div className="flex justify-start mt-2 space-x-1">
                      ...
                      <div className="mt-8">
                        <h4 className="font-body text-lg text-synthwave-neon-purple mb-4">
                          Advanced Floating Input
                        </h4>
                        <div className="relative">
                          <div className="bg-gradient-to-r from-synthwave-bg-card/90 via-synthwave-bg-card/95 to-synthwave-bg-card/90 backdrop-blur-xl border border-synthwave-neon-purple/20 shadow-2xl shadow-synthwave-neon-purple/20 rounded-xl p-6">
                            <p className="text-synthwave-text-secondary font-body mb-4 text-sm">
                              Next-gen floating input with gradient backgrounds,
                              enhanced blur effects, and seamless integration.
                            </p>
                            <div className="flex items-center space-x-4">
                              <div className="flex-1 bg-synthwave-bg-primary/30 backdrop-blur-sm border border-synthwave-neon-purple/20 rounded-xl p-4 focus-within:border-synthwave-neon-purple/50 transition-all duration-300">
                                <span className="text-synthwave-text-muted font-body">
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-synthwave-bg-card/60 border border-synthwave-neon-cyan/20 rounded-xl shadow-xl shadow-synthwave-neon-cyan/20 p-4">
                          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                            {/* Stat 1 - Pink */}
                            <div className="flex items-center gap-2 group cursor-pointer min-w-[120px]">
                              <div className="p-2 bg-synthwave-neon-pink/10 text-synthwave-neon-pink hover:bg-synthwave-neon-pink/20 hover:text-synthwave-neon-pink rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-synthwave-neon-pink/50">
                                <ConversationIcon />
                              </div>
                              <div className="min-w-0 flex-1">
                                <div className="text-lg font-header font-bold text-white group-hover:scale-105 transition-transform duration-300">
                                  12
                                </div>
                                <div className="text-xs text-synthwave-text-muted font-body uppercase tracking-wide">
                                  Chats
                                </div>
                              </div>
                            </div>
                            ...
                            {/* Stat 2 - Cyan */}
                            <div className="flex items-center gap-2 group cursor-pointer min-w-[120px]">
                              <div className="p-2 bg-synthwave-neon-cyan/10 text-synthwave-neon-cyan hover:bg-synthwave-neon-cyan/20 hover:text-synthwave-neon-cyan rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-synthwave-neon-cyan/50">
                                <ConversationIcon />
                              </div>
                              <div className="min-w-0 flex-1">
                                <div className="text-lg font-header font-bold text-white group-hover:scale-105 transition-transform duration-300">
                            ...
                            {/* Stat 3 - Purple */}
                            <div className="flex items-center gap-2 group cursor-pointer min-w-[120px]">
                              <div className="p-2 bg-synthwave-neon-purple/10 text-synthwave-neon-purple hover:bg-synthwave-neon-purple/20 hover:text-synthwave-neon-purple rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-synthwave-neon-purple/50">
                                <WorkoutIcon />
                              </div>
                              <div className="min-w-0 flex-1">
                                <div className="text-lg font-header font-bold text-white group-hover:scale-105 transition-transform duration-300">
                        ...
                        <div className="bg-synthwave-bg-card/20 border border-synthwave-neon-cyan/20 rounded-xl p-4">
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            ...
                            Horizontal layout with repeating pink → cyan →
                            purple color pattern, compact icon + number + label
                            design, hover animations, focus rings for
                            accessibility, responsive grid (2 cols mobile, 8
                            cols desktop), and consistent spacing. Perfect for
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/40 border border-synthwave-neon-cyan/30 rounded-xl p-4 md:p-6">
                            <h5 className="font-header text-base md:text-lg text-white mb-3 uppercase">
                              Responsive
                            </h5>
                            <p className="text-synthwave-text-secondary font-body text-sm md:text-base">
                              Responsive padding and typography that adapts to
                              screen size. Ensures optimal touch targets and
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/40 border border-synthwave-neon-pink/30 rounded-xl p-6">
                            <h5 className="font-header text-lg text-white mb-3 uppercase">
                              Touch UI
                            </h5>
                            <p className="text-synthwave-text-secondary font-body text-sm mb-4">
                              Generous spacing and large touch targets for
                              mobile interaction. Minimum 44px touch targets
                        ...
                        <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-cyan/30 rounded-xl p-6 mt-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-body">
                            <div>
                              ...
                              <ul className="space-y-1 text-synthwave-text-secondary">
                                <li>
                                  • Fixed height (40px) to prevent layout shift
                                </li>
                                <li>
                                  • Moderate border radius (8px) for modern look
                                </li>
                                <li>• Pink border with hover enhancement</li>
                                <li>
                                  • Normal font weight for comfortable editing
                                </li>
                              </ul>
                            </div>
                            <div>
                              ...
                              <ul className="space-y-1 text-synthwave-text-secondary">
                                ...
                                <li>
                                  • Consistent with save/cancel button styling
                                </li>
                          ...
                          <div className="mt-4 p-3 bg-synthwave-neon-pink/10 rounded-xl border border-synthwave-neon-pink/20">
                            <p className="text-synthwave-neon-pink font-body text-sm">
                              <strong>Usage:</strong> Import inputPatterns from
                              uiPatterns.js and use className=
                              {`${inputPatterns.inlineEdit}`} for consistent
                              inline editing across the application.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-pink/30 rounded-xl p-6 mt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-body">
                          <div>
                            ...
                            <ul className="space-y-1 text-synthwave-text-secondary">
                              <li>
                                • Diagonal gradient backgrounds with brand
                                colors
                              </li>
                              <li>
                        ...
                        <div className="mt-4 p-3 bg-synthwave-neon-cyan/10 rounded-xl border border-synthwave-neon-cyan/20">
                          <p className="text-synthwave-neon-cyan font-body text-sm">
                            <strong>Usage:</strong> Import toastPatterns from
                            uiPatterns.js and use className=
                            {`${toastPatterns.success}`} for consistent styling
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                          ...
                          />
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            Glassmorphism input with subtle backdrop blur, pink
                            accent borders, and smooth focus transitions.
                          </p>
                        </div>

                        {/* Error State Input */}
                        <div className="space-y-4">
                          <h4 className="font-body text-lg text-red-400 font-semibold">
                            Error State Input
                          </h4>
                          <input
                            type="email"
                          ...
                          <p className="text-red-400 font-body text-sm">
                            Error state with red borders and enhanced focus
                            styling for clear validation feedback.
                          </p>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          />
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            Fixed-height input for inline editing that prevents
                            layout shifts during edit mode.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-pink/30 rounded-xl p-6 mt-8">
                        ...
                        <div className="mt-4 p-3 bg-synthwave-neon-cyan/10 rounded-xl border border-synthwave-neon-cyan/20">
                          <p className="text-synthwave-neon-cyan font-body text-sm">
                            <strong>Usage:</strong> Import inputPatterns from
                            uiPatterns.js and use className=
                            {`${inputPatterns.standard}`} for consistent input
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="bg-synthwave-bg-card/20 backdrop-blur-xl border border-synthwave-neon-cyan/10 rounded-xl shadow-lg shadow-synthwave-neon-cyan/5 p-4 hover:bg-synthwave-bg-card/30 hover:border-synthwave-neon-cyan/15 transition-all duration-300">
                              <div className="flex items-center space-x-3 text-sm font-body">
                                <div className="p-1.5 bg-synthwave-neon-cyan/10 text-synthwave-neon-cyan rounded-xl hover:bg-synthwave-neon-cyan/20 transition-all duration-200">
                                  <HomeIcon />
                                </div>
                                ...
                                <span className="text-synthwave-neon-pink font-medium bg-synthwave-neon-pink/10 px-2 py-1 rounded-xl">
                                  Workouts
                                </span>
                              </div>
                            </div>
                            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                              <p className="text-green-400 font-body text-sm">
                                ...
                                shadows, rounded-xl corners, hover effects,
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {/* Minimal Clean Style */}
                            <div className="space-y-4">
                              <h5 className="font-body text-base text-synthwave-text-primary">
                                Minimal Clean
                              </h5>
                              <div className="bg-synthwave-bg-card/10 rounded-xl p-4 border-0">
                                <div className="flex items-center space-x-2 text-sm font-body">
                                  ...
                                  <span className="text-synthwave-text-muted/40">
                                    •
                                  </span>
                                  <span className="text-synthwave-neon-cyan hover:text-white transition-colors duration-200 cursor-pointer">
                                    Training
                              ...
                              <p className="text-synthwave-text-secondary font-body text-xs">
                                Ultra-minimal with dot separators and no
                                container styling.
                              </p>
                            </div>
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex items-center space-x-2 text-sm font-body">
                                <span className="bg-synthwave-neon-cyan/10 text-synthwave-neon-cyan px-3 py-1.5 rounded-full hover:bg-synthwave-neon-cyan/20 transition-all duration-200 cursor-pointer">
                                  Home
                                </span>
                                <div className="text-synthwave-text-muted/60">
                                  <ChevronRightIcon />
                                </div>
                                <span className="bg-synthwave-neon-purple/10 text-synthwave-neon-purple px-3 py-1.5 rounded-full hover:bg-synthwave-neon-purple/20 transition-all duration-200 cursor-pointer">
                                  Training
                                </span>
                                <div className="text-synthwave-text-muted/60">
                                  <ChevronRightIcon />
                              ...
                              <p className="text-synthwave-text-secondary font-body text-xs">
                                Individual pill-styled breadcrumbs with
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-full px-6 py-3 shadow-xl inline-flex items-center space-x-3 text-sm font-body">
                              ...
                              <p className="text-synthwave-text-secondary font-body text-xs">
                                Floating pill with heavy glassmorphism and
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-synthwave-bg-card/30 rounded-xl p-3 border border-synthwave-neon-pink/20">
                                <div className="flex items-center justify-between text-sm font-body">
                                  ...
                                  <div className="text-synthwave-text-muted text-xs">
                                    Training Grounds
                                  </div>
                                </div>
                              </div>
                              <p className="text-synthwave-text-secondary font-body text-xs">
                                Mobile-optimized with back button and context
                                hint.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-synthwave-bg-card/20 backdrop-blur-xl border border-synthwave-neon-cyan/10 rounded-xl p-6">
                              ...
                              <div>
                                ...
                                <ul className="space-y-2 text-synthwave-text-secondary">
                                  <li className="flex items-start space-x-2">
                                    ...
                                    <span>
                                      <strong>Hover Effects:</strong> Subtle
                                      background changes and color transitions
                                    </span>
                                  </li>
                                  <li className="flex items-start space-x-2">
                                    <span className="text-synthwave-neon-pink mt-0.5">
                                    ...
                                    <span>
                                      <strong>Active State:</strong> Current
                                      page highlighted with brand color and
                                      background
                                    </span>
                                  </li>
                                  <li className="flex items-start space-x-2">
                                    ...
                                    <span>
                                      <strong>Touch Friendly:</strong> Adequate
                                      padding for mobile interaction
                                    </span>
                                  </li>
                                  <li className="flex items-start space-x-2">
                                    <span className="text-synthwave-neon-pink mt-0.5">
                                    ...
                                    <span>
                                      ...
                                      Focus rings and arrow key support
                                    </span>
                                  </li>
                                </ul>
                              </div>
                              <div>
                                <h5 className="text-synthwave-neon-cyan font-semibold mb-3">
                                  Visual Enhancements:
                                </h5>
                                <ul className="space-y-2 text-synthwave-text-secondary">
                                  <li className="flex items-start space-x-2">
                                    ...
                                    <span>
                                      <strong>Glassmorphism:</strong> Backdrop
                                      blur with subtle transparency
                                    </span>
                                  </li>
                                  <li className="flex items-start space-x-2">
                                    <span className="text-synthwave-neon-cyan mt-0.5">
                                    ...
                                    <span>
                                      ...
                                      200-300ms duration for all interactions
                                    </span>
                                  </li>
                                  <li className="flex items-start space-x-2">
                                    <span className="text-synthwave-neon-cyan mt-0.5">
                                    ...
                                    <span>
                                      <strong>Consistent Spacing:</strong> 12px
                                      padding, 16px gaps between items
                                    </span>
                                  </li>
                                  <li className="flex items-start space-x-2">
                                    <span className="text-synthwave-neon-cyan mt-0.5">
                                    ...
                                    <span>
                                      <strong>Modern Icons:</strong> Rounded
                                      chevrons and iconography
                                    </span>
                                  </li>
                                </ul>
                              </div>
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <h4 className="font-body text-lg text-red-400 font-semibold">
                          Delete Modal Container (2025 Standards)
                        </h4>
                        <div className="flex justify-center">
                          <div
                            className={`${containerPatterns.deleteModal} p-6 max-w-md w-full`}
                          >
                            <div className="text-center">
                              <h5 className="text-red-400 font-body text-xl font-bold mb-2">
                                Delete Item
                              </h5>
                        ...
                        <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                          <p className="text-green-400 font-body text-sm">
                            ...
                            blur, 2xl border radius (16px), enhanced shadows for
                            depth, destructive theming with red accents, and
                            smooth transitions. Perfect for delete confirmations
                            and destructive actions.
                          </p>
                        </div>
                        <div className="bg-synthwave-neon-cyan/10 border border-synthwave-neon-cyan/20 rounded-xl p-4">
                          <p className="text-synthwave-neon-cyan font-body text-sm">
                            <strong>Usage:</strong> Import containerPatterns
                            from uiPatterns.js and use className=
                            {`${containerPatterns.deleteModal}`}
                            for consistent delete modal styling across the
                            application.
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <ul className="space-y-2 text-synthwave-text-primary font-body">
                            <li className="flex items-start space-x-2">
                              ...
                              <span>
                                <strong>Glassmorphism:</strong> Use
                                backdrop-blur for modern depth without heaviness
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-cyan mt-1">
                              ...
                              <span>
                                <strong>Rounded Corners:</strong> 2xl (16px) for
                                cards, xl (12px) for smaller elements
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-cyan mt-1">
                              ...
                              <span>
                                <strong>Subtle Animations:</strong> Hover
                                translations (-translate-y-1) and shadow changes
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-cyan mt-1">
                              ...
                              <span>
                                <strong>Consistent Spacing:</strong> 24px (p-6)
                                for cards, 16px (p-4) for compact elements
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-cyan mt-1">
                              ...
                              <span>
                                <strong>Color Hierarchy:</strong> Pink for
                                primary, cyan for secondary, purple for accent
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-cyan mt-1">
                              ...
                              <span>
                                <strong>Mobile First:</strong> Responsive
                                padding and touch-friendly sizing
                              </span>
                            </li>
                            <li className="flex items-start space-x-2">
                              <span className="text-synthwave-neon-cyan mt-1">
                              ...
                              <span>
                                <strong>Loading States:</strong> Skeleton
                                screens and progress indicators for better UX
                              </span>
                            </li>
                          </ul>
                        </div>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-cyan/20 rounded-xl p-6 space-y-4">
                      <p className="text-synthwave-text-primary font-body">
                        ...
                        Standardized inline editing pattern with consistent
                        sizing, colors, tooltips, and keyboard shortcuts. Used
                        for editing coach names, conversation titles, and
                        workout titles across the application.
                      </p>
                      <p className="text-synthwave-text-primary font-body">
                        <strong className="text-synthwave-neon-cyan">
                          Key Features:
                        </strong>{" "}
                        Three size variants (small/medium/large), pink accent
                        color matching FormInput/AuthInput, consistent tooltips
                        (edit=top, actions=bottom), keyboard shortcuts (Enter to
                        save, Esc to cancel), loading states, and flexible
                        validation.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-pink/20 rounded-xl p-6">
                        <div className="space-y-4">
                          ...
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            Used for compact UI elements, labels, or tags. Icon
                            size: Edit w-4 h-4, Actions w-3 h-3.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-pink/20 rounded-xl p-6">
                        <div className="space-y-4">
                          <div className="flex items-center space-x-2">
                            <span className="text-synthwave-text-secondary font-body">
                              Example:
                            </span>
                            <InlineEditField
                          ...
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            Used for standard titles like coach names and
                            conversation titles. Icon size: Edit w-5 h-5,
                            Actions w-4 h-4.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-pink/20 rounded-xl p-6">
                        <div className="space-y-4">
                          <div className="flex items-center space-x-2">
                            <span className="text-synthwave-text-secondary font-body text-lg">
                              Example:
                            </span>
                            <InlineEditField
                          ...
                          <p className="text-synthwave-text-secondary font-body text-sm">
                            Used for prominent headers like workout titles. Icon
                            size: Edit w-6 h-6, Actions w-5 h-5.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-pink/20 rounded-xl p-4">
                          <h5 className="font-body text-synthwave-neon-pink font-semibold mb-2">
                            Display Mode
                          </h5>
                          <ul className="space-y-1 text-synthwave-text-secondary font-body text-sm">
                            <li>• Hover reveals edit icon</li>
                            <li>• Pink accent on hover</li>
                            <li>
                              • Tooltip: "Edit [item] name" (top, offset 4px)
                            </li>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-synthwave-bg-primary/50 border border-synthwave-neon-cyan/30 rounded-xl p-4">
...
<InlineEditField
  ...
  size="large"
  displayClassName="font-body font-bold text-2xl text-white"
/>
...
const handleSaveCoachName = coachAgent.createCoachNameHandler(
  ...
  { success, error }
                    ...
                    <div className="bg-synthwave-bg-card/30 border border-synthwave-neon-cyan/20 rounded-xl p-6 space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <ul className="space-y-1 text-synthwave-text-secondary font-body text-sm">
                            <li>
                              • <strong>Small:</strong> Edit w-4 h-4, Actions
                              w-3 h-3
                            </li>
                            <li>
                              • <strong>Medium:</strong> Edit w-5 h-5, Actions
                              w-4 h-4
                            </li>
                            <li>
                              • <strong>Large:</strong> Edit w-6 h-6, Actions
                              w-5 h-5
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-1 text-synthwave-text-secondary font-body text-sm">
                            <li>
                              • <strong>Primary:</strong> Neon pink (#ff6ec7)
                            </li>
                            <li>
                              • <strong>Secondary:</strong> Neon cyan (#00f0ff)
                            </li>
                            <li>
                              • <strong>Input Border:</strong> Pink on focus
                            </li>
                            <li>
                              • <strong>Buttons:</strong> Pink primary, cyan
                              secondary
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-1 text-synthwave-text-secondary font-body text-sm">
                            <li>
                              • <strong>Edit:</strong> Top placement, offset 4px
                            </li>
                            <li>
                              • <strong>Actions:</strong> Bottom placement,
                              offset 8px
                            </li>
                            <li>
                              • <strong>Transform:</strong> translateX(-8px)
                            </li>
                            <li>
                              • <strong>Style:</strong> Black bg, white text,
                              8px radius
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-1 text-synthwave-text-secondary font-body text-sm">
                            <li>
                              • <strong>Enter:</strong> Save changes
                            </li>
                            <li>
                              • <strong>Escape:</strong> Cancel edit
                            </li>
                            <li>
                              • <strong>Auto-focus:</strong> Input on edit
                            </li>
                            <li>
                              • <strong>Disabled:</strong> When loading
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="bg-synthwave-neon-pink/10 border border-synthwave-neon-pink/20 rounded-xl p-4">
                      <p className="text-synthwave-neon-pink font-body text-sm">
                        ...
                        <code className="bg-synthwave-bg-primary px-1 rounded-xl">
                          inlineEditPatterns
                        </code>{" "}
                        from{" "}
                        <code className="bg-synthwave-bg-primary px-1 rounded-xl">
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-synthwave-text-primary font-body">
                          <li className="flex items-start space-x-2">
                            ...
                            <span>
                              <strong>Size Selection:</strong> Use small for
                              labels, medium for standard titles, large for
                              prominent headers
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            ...
                            <span>
                              <strong>Validation:</strong> Return true/false
                              from onSave to control edit mode exit
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Toast Notifications:</strong> Show
                              success/error messages in onSave handler
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Agent Integration:</strong> Use
                              CoachAgent.createCoachNameHandler() to eliminate
                              duplicate code
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            ...
                            <span>
                              <strong>Display Styling:</strong> Use
                              displayClassName prop for custom text styling
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Accessibility:</strong> Keyboard shortcuts
                              (Enter/Esc) and tooltips included
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
                            <span className="text-synthwave-neon-cyan mt-1">
                            ...
                            <span>
                              <strong>Loading States:</strong> Component handles
                              loading UI automatically during save
                            </span>
                          </li>
                        </ul>
                      </div>
