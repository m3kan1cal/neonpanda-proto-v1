...
export function NeonBorder({ children, color = "pink", className = "" }) {
  ...
  return (
    <div
      className={`border-2 ${borderColor[color]} rounded-xl transition-all duration-300 ${className}`}
    >
      {children}
    </div>
  );
  ...
  return (
    <input
      ...
      className={`
        ...
        px-4 py-3 rounded-xl font-body
...
export const BarChartUpIcon = ({ className = "w-8 h-8" }) => (
  <svg
    className={className}
    fill="currentColor"
    viewBox="0 0 24 24"
...
export const ReportIcon = () => <BarChartUpIcon className="w-8 h-8" />;

export const ReportIconSmall = () => <BarChartUpIcon className="w-5 h-5" />;
...
// Chat Icon - Conversation bubbles for coaching chat mode (3x3 size)
export const ChatIconTiny = ({ className = "w-3 h-3" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <polygon points="19 9 19 11 18 11 18 12 16 12 16 11 15 11 15 9 16 9 16 8 18 8 18 9 19 9" />
    <polygon points="14 9 14 11 13 11 13 12 11 12 11 11 10 11 10 9 11 9 11 8 13 8 13 9 14 9" />
    <polygon points="9 9 9 11 8 11 8 12 6 12 6 11 5 11 5 9 6 9 6 8 8 8 8 9 9 9" />
...
// Build Mode Icon - Grid/layout icon for Build mode (3x3 size)
export const BuildModeIconTiny = ({ className = "w-3 h-3" }) => (
...
export const CoachesIconTiny = ({ className = "w-4 h-4" }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 12.049 12.049 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"
    />
  </svg>
);
...
export const SignInIconTiny = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const BlogIconTiny = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const WhitePaperIconTiny = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const DocsIconTiny = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const ShareIconTiny = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// Globe icon for Global Memories
...
// Database icon for Total Reports
...
// Alternative icons for Total Reports
...
export const ArchiveIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M5 8h14M5 8a2 2 0 110-4h1.586a1 1 0 01.707.293l1.414 1.414a1 1 0 00.707.293h9.172a1 1 0 00.707-.293l1.414-1.414A1 1 0 0018.414 4H19a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"
    />
  </svg>
);
...
export const TrophySolidIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="currentColor"
    xmlns="http://www.w3.org/2000/svg"
...
export const NetworkIconTiny = ({ className = "w-4 h-4" }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2.5}
      d="M10.5 12h3M16 8l-1.5 1.5M16 16l-1.5-1.5"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2.5}
      d="M5.5 12c0-1.2 0.8-2 2-2s2 0.8 2 2"
    />
  </svg>
);
...
export const PlayIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m-5-10V3a1 1 0 011-1h1a1 1 0 011 1v1M5 7a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7z"
    />
  </svg>
);
...
export const TrainingReportsIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const TrainingPulseIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const NewBadge = () => (
  <div className="absolute -top-2 -right-2 z-20">
    <div className="relative">
      ...
      {/* Main badge */}
      <div className="relative bg-gradient-to-r from-synthwave-neon-pink to-synthwave-neon-purple text-black font-header font-black text-xs px-2 py-1 rounded-full uppercase tracking-wider shadow-lg shadow-synthwave-neon-pink/50 animate-pulse">
        NEW
      </div>
    </div>
  </div>
...
// Weekly Reports Icons
export const JsonIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
