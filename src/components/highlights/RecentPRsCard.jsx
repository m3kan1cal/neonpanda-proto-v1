        ...
        {visiblePrs.map((pr, index) => {
          ...
          return (
            <div
              ...
              className="relative bg-synthwave-bg-primary/40 border border-synthwave-neon-cyan/15 rounded-xl px-3 py-2 cursor-pointer transition-all duration-200 hover:bg-synthwave-bg-primary/60 hover:border-synthwave-neon-cyan/30 hover:shadow-lg hover:shadow-synthwave-neon-cyan/5 group"
            >
              {isNew && <NewBadge />}
