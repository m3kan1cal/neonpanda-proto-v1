    ...
    <div className={`${containerPatterns.cardMedium} p-6`}>
      ...
      <div className="grid grid-cols-2 gap-3">
        {exercises.slice(0, DISPLAY_LIMIT).map((ex) => (
          <div
            key={ex.exerciseName}
            className="rounded-xl bg-synthwave-bg-primary/40 border border-synthwave-neon-cyan/15 px-3 py-2 transition-all duration-200 hover:bg-synthwave-bg-primary/60 hover:border-synthwave-neon-cyan/30 hover:shadow-lg hover:shadow-synthwave-neon-cyan/5"
          >
