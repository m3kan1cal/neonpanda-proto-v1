            ...
            <div className="space-y-12">
              ...
              <div className={containerPatterns.mediumGlass}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                  <div className="bg-synthwave-bg-secondary/30 rounded-xl p-4 border border-synthwave-neon-cyan/20">
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                  ...
                  <div className="md:col-span-1">
                    <div className="bg-white rounded-xl p-4 mx-auto w-fit drop-shadow-lg">
                      <img
