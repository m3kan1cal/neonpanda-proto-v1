...
const ValueDisplay = ({
  ...
  return (
    <div
      className={`flex items-center gap-1.5 font-body text-sm ${className}`}
      data-json-path={dataPath}
    >
      <span className="text-synthwave-text-secondary">{label}:</span>
      <span
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="bg-synthwave-bg-primary/30 border border-synthwave-neon-cyan/20 rounded-xl p-4">
                      ...
                      />
                      <AiGeneratedBadge description="Comprehensive weekly analysis including performance trends, volume insights, and actionable recommendations" />
                    </div>
                  </div>
                </div>
              )}
                              ...
                              (movement, index) => (
                                ...
                                >
                                  <div className="flex items-center justify-between mb-2">
                                    ...
                                    <span className="text-sm font-body text-synthwave-text-secondary">
                          ...
                          <ul className="space-y-1">
                            {structured.actionable_insights.quick_wins.map(
                              (win, index) => (
                                <li
                                  key={index}
                                  className="text-synthwave-text-secondary font-body text-sm flex items-start space-x-2"
                                >
                            ...
                            (record, index) => (
                              ...
                              >
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <span
                                    className={`text-xs font-body uppercase px-2 py-1 rounded-xl ${
