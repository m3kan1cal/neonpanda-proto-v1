...
// Collapsible section component - Modern 2025 style matching WorkoutViewer
        ...
        >
          <div className={containerPatterns.infoCardCyan}>
            ...
            <div className="mt-3 p-3 bg-synthwave-bg-primary/30 rounded border border-synthwave-neon-cyan/20">
              ...
              <span className="text-synthwave-text-secondary font-rajdhani text-sm"> • Comprehensive weekly analysis including performance trends, volume insights, and actionable recommendations</span>
            </div>
          </div>
        </CollapsibleSection>
      )}
              ...
              <div>
                ...
                <div className="space-y-3">
                  {structured.performance_markers.benchmark_wods.map((wod, index) => (
                    <div key={index} className={containerPatterns.infoCardCyan}>
