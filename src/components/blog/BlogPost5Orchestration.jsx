    ...
    <>
      ...
      <section className="mb-16">
        ...
        <div className={`${containerPatterns.mediumGlass} mb-8`}>
          ...
          <div className="bg-synthwave-bg-primary/30 rounded-xl p-6">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="w-full max-w-lg">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="bg-synthwave-neon-pink/10 border border-synthwave-neon-pink/30 rounded-xl p-2 text-center">
                  ...
                  <div className="bg-synthwave-neon-cyan/10 border border-synthwave-neon-cyan/30 rounded-xl p-2 text-center">
                  ...
                  <div className="bg-synthwave-neon-purple/10 border border-synthwave-neon-purple/30 rounded-xl p-2 text-center">
        ...
        <div className={`${containerPatterns.mediumGlass} mb-8`}>
          <div className="space-y-8">
            ...
            <div className="border-l-2 border-synthwave-neon-pink pl-4">
              ...
              <div className="bg-synthwave-bg-primary/30 rounded-xl p-3 text-sm font-body space-y-2">
                <div className="flex items-start gap-2">
                  <span className="text-synthwave-neon-cyan font-semibold shrink-0">
                    Tool 1:
                  </span>
                  <span className="text-synthwave-text-secondary">
                    <code className="text-synthwave-neon-cyan bg-synthwave-bg-primary/50 px-1 rounded-xl">
                      get_todays_workout
                    </code>{" "}
                ...
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-synthwave-text-secondary">
                    <code className="text-synthwave-neon-purple bg-synthwave-bg-primary/50 px-1 rounded-xl">
                      retrieve_memories
                    </code>{" "}
            ...
            <div className="border-l-2 border-synthwave-neon-cyan pl-4">
              ...
              <div className="bg-synthwave-bg-primary/30 rounded-xl p-3 text-sm font-body space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-synthwave-text-secondary">
                    <code className="text-synthwave-neon-pink bg-synthwave-bg-primary/50 px-1 rounded-xl">
                      log_workout
                    </code>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className={containerPatterns.mediumGlass}>
            ...
            <p className="text-synthwave-text-secondary font-body text-sm mb-3">
              ...
              <code className="text-synthwave-neon-cyan bg-synthwave-bg-primary/50 px-1 rounded-xl text-xs">
                search_knowledge_base
              </code>{" "}
              and{" "}
              <code className="text-synthwave-neon-cyan bg-synthwave-bg-primary/50 px-1 rounded-xl text-xs">
        ...
        <div className={`${containerPatterns.mediumGlassPink} mb-8`}>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 rounded-xl bg-synthwave-neon-pink/20 flex items-center justify-center shrink-0">
            ...
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 rounded-xl bg-synthwave-neon-cyan/20 flex items-center justify-center shrink-0">
            ...
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 rounded-xl bg-synthwave-neon-purple/20 flex items-center justify-center shrink-0">
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className={containerPatterns.mediumGlassPurple}>
            ...
            <p className="text-synthwave-text-secondary font-body text-sm">
              Powers the{" "}
              <code className="text-synthwave-neon-purple bg-synthwave-bg-primary/50 px-1 rounded-xl text-xs">
                log_workout
              </code>{" "}
          ...
          <div className={containerPatterns.mediumGlassPink}>
            ...
            <p className="text-synthwave-text-secondary font-body text-sm">
              ...
              <code className="text-synthwave-neon-pink bg-synthwave-bg-primary/50 px-1 rounded-xl text-xs">
                get_todays_workout
              </code>{" "}
              and{" "}
              <code className="text-synthwave-neon-pink bg-synthwave-bg-primary/50 px-1 rounded-xl text-xs">
