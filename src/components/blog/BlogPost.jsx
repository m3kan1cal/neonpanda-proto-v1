    ...
    <div className={layoutPatterns.pageContainer}>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          {/* Breadcrumb */}
          <div className="flex items-center gap-2 text-sm font-body mb-6 bg-synthwave-bg-primary/40 backdrop-blur-sm px-4 py-2 rounded-xl border border-synthwave-neon-pink/20 w-fit">
            <Link
              to="/blog"
