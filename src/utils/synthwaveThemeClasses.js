...
export const themeClasses = {
  // Layout
  container:
    "bg-synthwave-gradient min-h-screen text-synthwave-text-primary font-rajdhani",
  ...
  // Typography
  heroTitle:
    "font-barlow font-black text-5xl md:text-6xl lg:text-7xl text-gradient-neon mb-8 drop-shadow-lg",
  heroSubtitle: "font-rajdhani text-2xl text-synthwave-text-secondary mb-6",
  heroDescription:
    "font-rajdhani text-lg text-synthwave-text-secondary mb-12 max-w-2xl mx-auto leading-relaxed",

  // Buttons
  neonButton:
    "bg-transparent border-2 border-synthwave-neon-pink text-synthwave-neon-pink px-8 py-3 rounded-md font-rajdhani font-semibold text-lg uppercase tracking-wide cursor-pointer transition-all duration-300 hover:bg-synthwave-neon-pink hover:text-synthwave-bg-primary hover:shadow-neon-pink hover:-translate-y-1 active:translate-y-0",
  ...
  // Text styles
  cardTitle: "font-barlow text-xl mb-4 uppercase tracking-wide",
