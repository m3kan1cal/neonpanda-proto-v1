...
export const themeClasses = {
  ...
  // Cards
  glowCard: "bg-card-gradient border border-synthwave-neon-pink/30 rounded-md p-8 shadow-card transition-all duration-300 hover:border-synthwave-neon-pink hover:shadow-glow hover:-translate-y-2",
