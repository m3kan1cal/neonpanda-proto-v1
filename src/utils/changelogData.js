  ...
  },
  {
    ...
    changes: {
      ...
      changed: [
        ...
        "Coach name font in SelectCoachModal updated to font-body font-semibold text-white text-lg matching CoachHeader.jsx",
        "Coach description font in SelectCoachModal updated to text-sm text-synthwave-text-secondary font-body for consistency",
  ...
  },
  {
    ...
    changes: {
      ...
      changed: [
        ...
        "Blog post 'The Foundation' sub-container headers changed from font-russo uppercase to font-body sentence case for consistency",
        "Blog post 'The Foundation' list item fonts standardized to font-body across 'Why Serverless?' and 'What It Does' sections",
  ...
  },
  {
    ...
    changes: {
      ...
      changed: [
        ...
        "Technology page font in pattern containers and philosophy section to font-body for consistency",
  ...
  },
  {
    ...
    changes: {
      ...
      changed: [
        ...
        "Timeline dates now display in clean vertical list format using font-body text-sm matching phase metadata style",
  ...
  },
  {
    ...
    changes: {
      ...
      changed: [
        ...
        "Menu item icons sized to w-4 h-4 for consistency with text (font-body font-medium text-sm)",
